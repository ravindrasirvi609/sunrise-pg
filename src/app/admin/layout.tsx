...
export default function AdminLayout({
      ...
      icon: (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M12 8c-1.657 0-3 1.343-3 3s1.343 3 3 3 3-1.343 3-3-1.343-3-3-3zm0 0V4m0 10v4m8-8a8 8 0 11-16 0 8 8 0 0116 0z"
          />
        </svg>
      ),
    },
    {
      name: "User Archives & Checkouts",
      href: "/admin/users/checkouts",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-6 w-6"
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-gradient-to-br from-orange-50 via-white to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-orange-900">
      ...
      {sidebarOpen && (
        <div
          className="fixed inset-0 z-40 backdrop-blur-sm bg-gray-600/30 dark:bg-black/30 md:hidden"
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 flex flex-col z-50 w-64 transition-transform duration-300 ease-in-out transform ${
          sidebarOpen ? "translate-x-0" : "-translate-x-full"
        } md:translate-x-0 md:relative md:z-0`}
      >
        <div className="h-full backdrop-blur-xl bg-white/50 dark:bg-gray-900/50 border-r border-white/20 dark:border-gray-700/30 shadow-xl flex flex-col">
          {/* Logo */}
        ...
        <header className="backdrop-blur-xl bg-white/50 dark:bg-gray-900/50 border-b border-white/20 dark:border-gray-700/30 shadow-sm">
          <div className="px-4 sm:px-6 h-16 flex justify-between items-center">
            <div className="flex items-center">
              ...
              <h1 className="ml-4 md:ml-0 text-lg font-semibold text-gray-900 dark:text-white">
                Admin Portal
              </h1>
            </div>
